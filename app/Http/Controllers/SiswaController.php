...
class SiswaController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
       ...
       if($request->hasFile('foto')) {
        ...
        //proses masukkan nama file baru
        // $data = [
        //     'foto' => $foto_nama
        // ];
        $data['foto'] = $foto_nama;
       ...
       return redirect('/siswa')->with('success','Berhasil melakukan perubahan  data');
    ...
    public function destroy($id)
    {
        ...
        return redirect('/siswa')->with('success','Berhasil melakukan hapus data');
    }
}
